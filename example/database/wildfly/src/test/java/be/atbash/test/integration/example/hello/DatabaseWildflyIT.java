...
@DatabaseContainerIntegrationTest(
        containerIntegrationTest = @ContainerIntegrationTest(runtime = SupportedRuntime.WILDFLY)
        , jndiDatasourceName = "java:jboss/datasources/cloud-mysql"
)
public class DatabaseWildflyIT extends AbstractDatabaseContainerIntegrationTest {
