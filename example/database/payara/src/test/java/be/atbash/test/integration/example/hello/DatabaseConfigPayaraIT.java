...
public class DatabaseConfigPayaraIT extends AbstractDatabaseContainerIntegrationTest {
    ...
    void getConfigParameters() {
        String parameters = helloService.getParameters();
        Assertions.assertThat(parameters).isEqualTo("config \n" +
                "jdbc:mysql://db:3306/test?useSSL=false\n" +
                "test\n" +
                "test");
    }
}