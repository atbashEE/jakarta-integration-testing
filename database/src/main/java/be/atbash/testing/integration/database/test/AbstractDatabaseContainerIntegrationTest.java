 ...
 */
package be.atbash.testing.integration.database.test;

import be.atbash.testing.integration.test.AbstractContainerIntegrationTest;
import org.dbunit.database.IDatabaseConnection;
import org.testcontainers.containers.JdbcDatabaseContainer;

public abstract class AbstractDatabaseContainerIntegrationTest extends AbstractContainerIntegrationTest {
